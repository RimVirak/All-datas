...
<div class="entry_col1 vx_label"><label for="vx_field"><?php _e('Select Field','contact-form-ccontact-crm') ?></label></div>
<div class="entry_col2">
...
<div class="entry_col1 vx_label"><label for="vx_value"> <?php _e('Custom Value','contact-form-ccontact-crm') ?></label></div>
<div class="entry_col2">
<input type="text" name='value' placeholder='<?php _e("Custom Value",'contact-form-ccontact-crm')?>' class='vx_input_100'>
</div>
<div class="crm_clear"></div>
</div>  
...
<div class="vx_div">
     <div class="vx_head">
<div class="crm_head_div"> <?php echo sprintf(__('%s. Add Note.', 'contact-form-ccontact-crm'),$panel_count+=1); ?></div>
...
<div class="crm_clear"></div> 
  ...
  <div class="vx_col1">
  <label for="crm_note">
  <?php _e("Add Note ", 'contact-form-ccontact-crm'); ?>
  ...
  <?php _e("Enable", 'contact-form-ccontact-crm'); ?>
  </label>
  </div>
  <div style="clear: both;"></div>
  </div>
  ...
  <?php _e( 'Note Fields ', 'contact-form-ccontact-crm' ); $this->tooltip("vx_note_fields") ?>
  </label>
  </div>
  <div class="vx_col2">
  ...
  <?php echo $this->form_fields_options($form_id,$this->post('note_fields',$meta)); ?>
    ...
    <span class="howto">
  <?php _e('You can select multiple fields.', 'contact-form-ccontact-crm'); ?>
  </span>
   </div>
  <div style="clear: both;"></div>
  </div>
  ...
  <?php _e( 'Disable Note ', 'contact-form-ccontact-crm' ); $this->tooltip("vx_disable_note") ?>
  </label>
  </div>
  <div class="vx_col2">
  
  <input type="checkbox" style="margin-top: 0px;" id="crm_disable_note" class="crm_toggle_check" name="meta[disable_entry_note]" value="1" checked="checked" disabled="disabled"/>
  <label for="crm_disable_note">
  <?php _e('Do not Add Note if entry already exists in Constant Contact', 'contact-form-ccontact-crm'); ?>
  </label>
...
?>
     <div class="vx_div vx_refresh_panel">    
      <div class="vx_head ">
<div class="crm_head_div"> <?php echo sprintf(__('%s. List settings',  'contact-form-ccontact-crm' ),$panel_count); ?></div>
<div class="crm_btn_div"><i class="fa crm_toggle_btn fa-minus" title="<?php _e('Expand / Collapse','contact-form-ccontact-crm') ?>"></i></div>
<div class="crm_clear"></div> 
  </div>                 
    <div class="vx_group ">
   <div class="vx_row"> 
   <div class="vx_col1"> 
  <label for="crm_sel_status"><?php _e('Status', 'contact-form-ccontact-crm'); ?></label>
  </div>
  <div class="vx_col2">
...
<div class="clear"></div>
   ...
   <!--div class="vx_row"> 
   <div class="vx_col1"> 
  <label for="crm_sel_language"><?php _e('Source', 'contact-form-ccontact-crm'); ?></label>
  </div>
  <div class="vx_col2">
  <input type="text" id="crm_sel_language" name="meta[source]" style="width: 100%;" value="<?php echo $this->post('source',$meta); ?>" autocomplete="off">
  </div>
<div class="clear"></div>
</div>
   ...
   <div class="vx_row"> 
   <div class="vx_col1"> 
  <label for="crm_sel_language"><?php _e('Source Detail', 'contact-form-ccontact-crm'); ?></label>
  </div>
  <div class="vx_col2">
  <input type="text" id="crm_sel_language" name="meta[source_detail]" style="width: 100%;" value="<?php echo $this->post('source_detail',$meta); ?>" autocomplete="off">
  </div>
<div class="clear"></div>
</div--->
